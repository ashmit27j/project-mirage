...
document.querySelector(".js-big-bang-button").addEventListener("click", () => {
  ...
  if (bigBangMode) {
    document.querySelector(".js-big-bang-button").innerHTML = "BBT Mode: On";
    document.body.style.backgroundImage = 'url("/static/images/BBT.png")';
  } else {
    document.querySelector(".js-big-bang-button").innerHTML = "BBT Mode: Off";
    document.body.style.backgroundImage =
      'url("/static/images/rockpaperscissor_bg.png")';
  }
...
function playGame(playerMove) {
  ...
  if (result === "You win!") {
    document.querySelector(".js-result").style.color = "#78FF38";
  } else if (result === "You lose!") {
    document.querySelector(".js-result").style.color = "#FF3838";
  } else if (result === "Tie!") {
    document.querySelector(".js-result").style.color = "#38A0FF";
  } else {
  ...
  document.querySelector(
    ".js-moves"
  ).innerHTML = `You <img src="/static/images/${playerMove.toLowerCase()}-emoji.png" class="move-icon" /> | <img src="/static/images/${computerMove.toLowerCase()}-emoji.png" class="move-icon"> PC`;
}
...
function updateScoreElement() {
  ...
  document.querySelector(".js-wins").innerHTML = `Won: ${score.wins}`;
  document.querySelector(".js-ties").innerHTML = `Tied: ${score.ties}`;
  document.querySelector(".js-losses").innerHTML = `Lost: ${score.losses}`;
}
