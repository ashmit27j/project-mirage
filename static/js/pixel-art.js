...
document.getElementById("selectAnyColorBtn").addEventListener("click", () => {
  isRandomMode = false;
  isColorSelectionMode = !isRandomMode; // Set color selection mode to active if random mode is off
  isEraserMode = false; // Deactivate eraser mode
...
images[0] = ['url("../images/sleeping-cat.png")'];
images[1] = ['url("../images/awake-cat.png")'];
var index = 0;

function change() {
  document.getElementById("cat").src = images[index];
  if (index == 1) {
    index = 0;
  } else {
    index++;
